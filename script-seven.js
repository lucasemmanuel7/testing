  ...
  totalOfProducts = 0;
    ...
    allProducts.forEach(data => {
        ...
        ctnProductWsp.innerHTML =  `
          ...
          <div class="test">
              <br> <strong> Producto: &nbsp ${(data.title).toUpperCase()} </strong> <br/>
              <br> <strong> Comprar: &nbsp ${data.order} </strong> <br/>
...
$(".enviar").click(function(){
  ...
  let tester = document.querySelectorAll(".test");
  // let ctnMessageWsp = document.querySelector(".ctn-messages");
  ...
  if( contain >= 1 ){
      ...
      if (phone){
          window.location = "https://api.whatsapp.com/send?phone="+phone+"&text="+test.textContent;
      }
  }  
